    ...
    <main>
      <nav className="top-nav">
        ...
        <div>
          ...
          <a className="nav-cta" href="#analyzer">Token 工具</a>
        </div>
      </nav>
      ...
      <section className="proxyman-section" id="proxyman">
        <SectionTitle kicker="2026-08-19 · PROXYMAN RE-CAPTURE">重新抓取全流程：设置、英文验证、证据与清理</SectionTitle>
        ...
        <div className="privacy-callout">
          <b>本轮清理已完成：</b>临时 529 重试服务已停止，Windows 系统代理已关闭；Proxyman 与本机 CA 保留，方便下次 workshop 复用。若不再使用，应删除 SSL Proxying 规则并卸载 Proxyman Root CA。
        </div>
      </section>
